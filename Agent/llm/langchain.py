...
This module is meant to be a wrapper around Langchain LLMs to make the Agent interoperable with LangChain.
"""

from Agent.prompts.base import Prompt
...
class LangchainLLM(LLM):
    """
    Class to wrap Langchain LLMs and make Agent interoperable
    with LangChain.
    """
